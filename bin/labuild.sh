...
sed -e "s/BUILDID/$v/g"  resources/Info.plist > resources/Info.plist.tmp
...
function buildTarget {
    ...
    $xcodebuild -target "$1" -configuration Release OBJROOT=/tmp/jstalk/build SYMROOT=/tmp/letters/build OTHER_CFLAGS=""
